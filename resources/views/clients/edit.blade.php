...
<div class="max-w-2xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800 tracking-tight">Edit Client Details</h2>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="bg-slate-50 px-8 py-4 border-b border-gray-100">
            <p class="text-sm text-gray-500 uppercase font-bold tracking-wider">Update Information for: <span class="text-blue-600">{{ $client->name }}</span></p>
        </div>

        <form method="POST" action="/clients/{{ $client->id }}" class="p-8 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="name" value="{{ $client->name }}" placeholder="e.g. John Doe" 
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="phone" value="{{ $client->phone }}" placeholder="+91 00000 00000" 
                        class="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200 bg-gray-50 focus:bg-white" required>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="address" rows="3" placeholder="Enter full address here..." 
                    class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200 bg-gray-50 focus:bg-white">{{ $client->address }}</textarea>
            </div>
